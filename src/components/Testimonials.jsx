            ...
            <div className="flex justify-center items-center pb-10 sm:pb-20 md:pb-30 lg:pb-40.5">
                <div className="max-w-[1284px] px-3">
                    ...
                    {/* <div className="flex items-center justify-between">
                        <div className="next-btn absolute left-[132px] w-10 h-10 rounded-[34px] border border-[#00171F] flex items-center justify-center hover:bg-[#00171F] swiper-arrow transition-all duration-200 ease-linear cursor-pointer"><SwiperPrevArrow /></div>
                        <div className="prev-btn absolute right-[132px] w-10 h-10 rounded-[34px] border border-[#00171F] flex items-center justify-center hover:bg-[#00171F] swiper-arrow transition-all duration-200 ease-linear cursor-pointer"><SwiperNextArrow /></div>
                    </div> */}
