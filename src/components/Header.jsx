        ...
        <nav className='px-4'>
            <div className="flex justify-between items-center py-4">
                ...
                <ul id='nav-name' className={`list-unstyled flex justify-center items-center nav-link gap-6 mb-0 ${menuOpen ? "show-navbar" : ""}`}>
                    <li><a className='font-family-primary font-normal text-base leading-[100%] opacity-90 capitalize text-white hover:opacity-100 relative after:absolute after:-bottom-1 after:left-1/2 after:-translate-x-1/2 after:h-0.5 after:w-0 after:bg-white after:rounded hover:after:w-full after:duration-300 after:ease-linear after:transition-all' href="#about">About</a></li>
                    <li><a className='font-family-primary font-normal text-base leading-[100%] opacity-90 capitalize text-white hover:opacity-100 relative after:absolute after:-bottom-1 after:left-1/2 after:-translate-x-1/2 after:h-0.5 after:w-0 after:bg-white after:rounded hover:after:w-full after:duration-300 after:ease-linear after:transition-all' href="#works">How It Works</a></li>
                    <li><a className='font-family-primary font-normal text-base leading-[100%] opacity-90 capitalize text-white hover:opacity-100 relative after:absolute after:-bottom-1 after:left-1/2 after:-translate-x-1/2 after:h-0.5 after:w-0 after:bg-white after:rounded hover:after:w-full after:duration-300 after:ease-linear after:transition-all' href="#service">Services</a></li>
                    <li><a className='font-family-primary font-normal text-base leading-[100%] opacity-90 capitalize text-white hover:opacity-100 relative after:absolute after:-bottom-1 after:left-1/2 after:-translate-x-1/2 after:h-0.5 after:w-0 after:bg-white after:rounded hover:after:w-full after:duration-300 after:ease-linear after:transition-all' href="#testimonials">Testimonials</a></li>
                    <li><a className='font-family-primary font-normal text-base leading-[100%] opacity-90 capitalize text-white hover:opacity-100 relative after:absolute after:-bottom-1 after:left-1/2 after:-translate-x-1/2 after:h-0.5 after:w-0 after:bg-white after:rounded hover:after:w-full after:duration-300 after:ease-linear after:transition-all' href="#why">Why Us</a></li>
                    <li><a className='font-family-primary font-normal text-base leading-[100%] opacity-90 capitalize text-white hover:opacity-100 relative after:absolute after:-bottom-1 after:left-1/2 after:-translate-x-1/2 after:h-0.5 after:w-0 after:bg-white after:rounded hover:after:w-full after:duration-300 after:ease-linear after:transition-all' href="#FAQ">FAQ</a></li>
