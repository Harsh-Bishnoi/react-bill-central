            ...
            <div className="flex justify-center items-center pb-10 sm:pb-20 md:pb-30 lg:pb-40.5">
                <div className="w-full max-w-[1440px]">
                    ...
                    <div className="flex justify-center px-3 pb-[30px] sm:pb-[58px]">
                        <CustomDescription descriptionClass="max-w-[610px] text-center" descriptionText="Lorem ipsum dolor sit amet consectetur. Semper vitae nullam eget consectetur mi. Vulputate sapien a a bibendum" />
                    </div>
                    <Swiper
                        spaceBetween={0}
                        slidesPerView={4}
                                ...
                                <div data-aos="fade-down"
                                    ...
                                    <div className="bg-[#003459] p-4 sm:p-8 min-h-[217px] absolute bottom-0 group-hover:translate-y-0 transition-all duration-200 ease-linear translate-y-[105%] ">
                                        <div className="flex gap-2 mb-3.5">
                                            <h2 className='font-family-primary font-normal text-[24px] xl:text-[28px] 2xl:text-[30px] leading-[110%] capitalize text-white'>{item.number}</h2>
                                            <h3 className='font-family-primary font-normal text-[24px] xl:text-[28px] 2xl:text-[30px] leading-[110%] capitalize text-white'>{item.text}</h3>
                                        </div>
