...
const ChooseUtilities = () => {
    return (
        <>
            <div className="flex justify-center items-center pb-[162px]">
                <div className="max-w-[1140px] px-3">
                    ...
                    <div className="flex gap-6 flex-wrap justify-center">
                        <div className="max-w-[400px] rounded-sm bg-[#003459] p-5 sm:p-10">
                        ...
                        <div className="max-w-[692px] mx-auto">
                            <div className="flex gap-6 flex-wrap justify-center">
                                <div className="max-w-[334px] border rounded-sm border-[#00171F1A] p-4 sm:p-6 shadow-[0px_0px_13.9px_0px_#0000001A]">
                            ...
                            <div className="flex flex-wrap gap-6 mt-6 justify-center">
                                <div className="max-w-[334px] w-full min-h-[286px] border rounded-sm border-[#00171F1A] p-4 sm:p-6 shadow-[0px_0px_13.9px_0px_#0000001A]">
                                ...
                                <div className="max-w-[334px] min-h-[286px] border rounded-sm border-[#00171F1A] p-4 sm:p-6 shadow-[0px_0px_13.9px_0px_#0000001A]">
